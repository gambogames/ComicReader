...
//#endif
  ...
  // Create root view controller
    ...
    {
        library = [[[LibraryViewController alloc] initWithNibName:@"LibraryViewController" bundle:nil] autorelease];
    } else {
        library = [[[LibraryViewController alloc] initWithNibName:@"LibraryViewController~iphone" bundle:nil] autorelease];

    }
    
    [library initWithWindow:self.window];
    
    self.viewController = library;
    
    DBSession *dbSession = [[DBSession alloc] initWithAppKey:@"8be0e3beubiafrv" appSecret:@"moh3fvqxbsse1ox" root:kDBRootDropbox];
