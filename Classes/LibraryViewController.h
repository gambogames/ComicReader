...
@interface LibraryViewController : UIViewController <UINavigationBarDelegate, UIPopoverControllerDelegate, DropboxBrowserDelegate> {
@private
  GridView* _gridView;
  ...
  UIPopoverController* _menuController;
    UIViewController* _menuControllerIPhone;
...
@property (retain, nonatomic) IBOutlet UIButton *btnSyncDropbox;
